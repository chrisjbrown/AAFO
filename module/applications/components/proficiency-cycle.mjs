...
export default class ProficiencyCycleElement extends AdoptedStyleSheetMixin(HTMLElement) {
  ...
  static CSS = `
    ...
    div { --_fill: var(--proficiency-cycle-enabled-color, var(--aafo-color-blue)); }
    div:has(:disabled, :focus-visible) { --_fill: var(--proficiency-cycle-disabled-color, var(--aafo-color-gold)); }
  ...
  #refreshValue() {
    ...
    this.#internals.ariaValueText = CONFIG.AAFO.proficiencyLevels[this.#value];
