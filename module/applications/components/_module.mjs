...
window.customElements.define("aafo-effects", EffectsElement);
window.customElements.define("aafo-icon", IconElement);
window.customElements.define("aafo-inventory", InventoryElement);
