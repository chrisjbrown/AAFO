...
export default class ActorArmorConfig extends BaseConfigSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["aafo", "actor-armor-config"],
      template: "systems/aafo/templates/apps/actor-armor.hbs",
      width: 320,
      height: "auto"
    });
  }
  ...
  /** @inheritdoc */
  get title() {
    return `${game.i18n.localize("AAFO.ArmorConfig")}: ${this.document.name}`;
  }
  ...
  async getData() {
    ...
    return {
      ac, isFlat,
      calculations: CONFIG.AAFO.armorClasses,
