...
export default class ActorTypeConfig extends DocumentSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["aafo", "actor-type", "trait-selector"],
      template: "systems/aafo/templates/apps/actor-type.hbs",
      width: 280,
      height: "auto",
      choices: {},
      allowCustom: true,
  ...
  /** @inheritdoc */
  get title() {
    return `${game.i18n.localize("AAFO.CreatureTypeTitle")}: ${this.object.name}`;
  }
  ...
  getData(options={}) {
    ...
    if ( foundry.utils.getType(attr) !== "Object" ) attr = {
      value: (attr in CONFIG.AAFO.creatureTypes) ? attr : "humanoid",
      subtype: "",
      swarm: "",
      custom: ""
    };
    ...
    // Populate choices
    const types = {};
    for ( let [k, v] of Object.entries(CONFIG.AAFO.creatureTypes) ) {
      types[k] = {
    ...
    return {
      ...
      custom: {
        value: attr.custom,
        label: game.i18n.localize("AAFO.CreatureTypeSelectorCustom"),
      ...
      swarm: attr.swarm,
      sizes: Array.from(Object.entries(CONFIG.AAFO.actorSizes)).reverse().reduce((obj, [key, { label }]) => {
        obj[key] = label;
        return obj;
      }, {}),
