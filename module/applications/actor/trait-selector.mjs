...
export default class TraitSelector extends BaseConfigSheet {
  constructor(actor, trait, options={}) {
    if ( !CONFIG.AAFO.traits[trait] ) throw new Error(
      `Cannot instantiate TraitSelector with a trait not defined in CONFIG.AAFO.traits: ${trait}.`
    );
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      id: "trait-selector",
      classes: ["aafo", "trait-selector", "subconfig"],
      template: "systems/aafo/templates/apps/trait-selector.hbs",
      width: 320,
      height: "auto",
      allowCustom: true
    });
  ...
  async getData() {
    ...
    return {
      ...
      bypasses: "bypasses" in data ? Object.entries(CONFIG.AAFO.itemProperties).reduce((obj, [k, v]) => {
