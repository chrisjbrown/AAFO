...
export default class ActorHitPointsConfig extends BaseConfigSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["aafo", "actor-hit-points-config"],
      template: "systems/aafo/templates/apps/hit-points-config.hbs",
      width: 320,
      height: "auto"
    });
  }
  ...
  /** @inheritdoc */
  get title() {
    return `${game.i18n.localize("AAFO.HitPointsConfig")}: ${this.document.name}`;
  }
  ...
  async _onRollHPFormula(event) {
    ...
    try {
      ...
      ui.notifications.error("AAFO.HPFormulaError", {localize: true});
      throw error;
    }
  }
}
