...
export default class DamageModificationConfig extends BaseConfig {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["aafo", "damage-modification", "trait-selector", "subconfig"],
      template: "systems/aafo/templates/apps/damage-modification-config.hbs",
      width: 320,
      height: "auto"
    });
  }
  ...
  /** @inheritDoc */
  get title() {
    return game.i18n.localize("AAFO.DamageModification.Label");
  }
  ...
  async getData(options={}) {
    ...
    context.bypasses = Object.entries(CONFIG.AAFO.itemProperties).reduce((obj, [k, v]) => {
      if ( v.isPhysical ) obj[k] = { ...v, chosen: data.bypasses.has(k) };
      return obj;
    }, {});
    context.modifications = Object.entries(CONFIG.AAFO.damageTypes).reduce((obj, [k, v]) => {
      obj[k] = {
        ...v,
        value: data.amount[k]
      };
