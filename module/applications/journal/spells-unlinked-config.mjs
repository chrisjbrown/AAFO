...
export default class SpellsUnlinkedConfig extends DocumentSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["aafo", "unlinked-spell-config"],
      template: "systems/aafo/templates/journal/page-spell-list-unlinked-config.hbs",
      width: 400,
      height: "auto",
      sheetConfig: false
    });
  ...
  get title() {
    return `${game.i18n.localize(
      "JOURNALENTRYPAGE.AAFO.SpellList.UnlinkedSpells.Configuration")}: ${this.document.name}`;
  }
