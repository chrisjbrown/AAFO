...
export default class CurrencyManager extends DialogMixin(FormApplication) {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["aafo2", "currency-manager", "dialog"],
      tabs: [{navSelector: "nav", contentSelector: ".sheet-content", initial: "transfer"}],
      template: "systems/aafo/templates/apps/currency-manager.hbs",
      title: "AAFO.CurrencyManager.Title",
      width: 350,
      height: "auto"
    });
  }
   ...
   * See CONFIG.AAFO.currencies for configuration.
  ...
  static convertCurrency(doc) {
    ...
    const currencies = Object.entries(CONFIG.AAFO.currencies);
