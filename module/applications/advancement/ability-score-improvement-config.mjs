...
export default class AbilityScoreImprovementConfig extends AdvancementConfig {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      template: "systems/aafo/templates/advancement/ability-score-improvement-config.hbs"
    });
  }
  ...
  getData() {
    ...
    return foundry.utils.mergeObject(super.getData(), {
      ...
      points: {
        ...
        label: game.i18n.localize("AAFO.AdvancementAbilityScoreImprovementPoints"),
        min: 0,
