...
export default class ItemChoiceConfig extends AdvancementConfig {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["aafo", "advancement", "item-choice", "three-column"],
      dragDrop: [{ dropSelector: ".drop-target" }],
      dropKeyPath: "pool",
      template: "systems/aafo/templates/advancement/item-choice-config.hbs",
      width: 780
    });
  }
  ...
  getData(options={}) {
    ...
    const context = {
      ...
      abilities: Object.entries(CONFIG.AAFO.abilities).reduce((obj, [k, c]) => {
    ...
    if ( this.advancement.configuration.type === "feat" ) {
      const selectedType = CONFIG.AAFO.featureTypes[this.advancement.configuration.restriction.type];
      context.typeRestriction = {
        typeLabel: game.i18n.localize("AAFO.ItemFeatureType"),
        typeOptions: CONFIG.AAFO.featureTypes,
        subtypeLabel: game.i18n.format("AAFO.ItemFeatureSubtype", {category: selectedType?.label}),
