...
export class ScaleValueConfigurationData extends foundry.abstract.DataModel {
  ...
  static defineSchema() {
    return {
      identifier: new IdentifierField({required: true, label: "AAFO.Identifier"}),
      type: new foundry.data.fields.StringField({
        required: true, initial: "string", choices: TYPES, label: "AAFO.AdvancementScaleValueTypeLabel"
      }),
      distance: new foundry.data.fields.SchemaField({
        units: new foundry.data.fields.StringField({required: true, label: "AAFO.MovementUnits"})
      }),
...
export class ScaleValueType extends foundry.abstract.DataModel {
  ...
  static get metadata() {
    return {
      label: "AAFO.AdvancementScaleValueTypeString",
      hint: "AAFO.AdvancementScaleValueTypeHintString",
      isNumeric: false
    };
  }
...
export class ScaleValueTypeNumber extends ScaleValueType {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      label: "AAFO.AdvancementScaleValueTypeNumber",
      hint: "AAFO.AdvancementScaleValueTypeHintNumber",
      isNumeric: true
    });
  }
...
export class ScaleValueTypeCR extends ScaleValueTypeNumber {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      label: "AAFO.AdvancementScaleValueTypeCR",
      hint: "AAFO.AdvancementScaleValueTypeHintCR"
    });
  }
...
export class ScaleValueTypeDice extends ScaleValueType {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      label: "AAFO.AdvancementScaleValueTypeDice",
      hint: "AAFO.AdvancementScaleValueTypeHintDice"
    });
  }
  ...
  get mods() {
    ...
    return this.modifiers.reduce((acc, mod) => {
      return acc + (aafo.utils.isValidDieModifier(mod) ? mod : "");
    }, "");
  }
...
export class ScaleValueTypeDistance extends ScaleValueTypeNumber {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      label: "AAFO.AdvancementScaleValueTypeDistance",
      hint: "AAFO.AdvancementScaleValueTypeHintDistance"
    });
  }
  ...
  /** @inheritdoc */
  get display() {
    return `${this.value} ${CONFIG.AAFO.movementUnits[this.parent.configuration.distance?.units ?? "ft"]}`;
  }
}
