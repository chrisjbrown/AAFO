...
export default class SpellConfigurationData extends foundry.abstract.DataModel {
  ...
  static defineSchema() {
    return {
      ...
      preparation: new StringField({label: "AAFO.SpellPreparationMode"}),
      uses: new SchemaField({
        max: new FormulaField({deterministic: true, label: "AAFO.UsesMax"}),
        per: new StringField({label: "AAFO.UsesPeriod"})
