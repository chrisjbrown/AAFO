  ...
  static defineSchema() {
    return {
      points: new foundry.data.fields.NumberField({
        integer: true, min: 0, initial: 70,
        label: "AAFO.AdvancementAbilityScoreImprovementPoints",
        hint: "AAFO.AdvancementAbilityScoreImprovementPointsHint"
      }),
      ...
      cap: new foundry.data.fields.NumberField({
        integer: true, min: 1, initial: 10, label: "AAFO.AdvancementAbilityScoreImprovementCap",
        hint: "AAFO.AdvancementAbilityScoreImprovementCapHint"
      })
    };
  }
}
  ...
  static defineSchema() {
    return {
      ...
      feat: new MappingField(new foundry.data.fields.StringField(), {
        required: false, initial: undefined, label: "AAFO.Feature.Feat"
      })
    };
  }
}
