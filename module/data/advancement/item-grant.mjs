  ...
  static defineSchema() {
    return {
      items: new ArrayField(new SchemaField({
        ...
        optional: new BooleanField({label: "AAFO.AdvancementItemGrantOptional"})
      }), {required: true, label: "DOCUMENT.Items"}),
      optional: new BooleanField({
        required: true, label: "AAFO.AdvancementItemGrantOptional", hint: "AAFO.AdvancementItemGrantOptionalHint"
      }),
