...
export default class DetailsField {
  ...
  static get common() {
    return {
      biography: new foundry.data.fields.SchemaField({
        value: new foundry.data.fields.HTMLField({label: "AAFO.Biography"}),
        public: new foundry.data.fields.HTMLField({label: "AAFO.BiographyPublic"})
      }, {label: "AAFO.Biography"})
    };
  }
  ...
  static get creature() {
    return {
      alignment: new foundry.data.fields.StringField({required: true, label: "AAFO.Alignment"}),
      race: new LocalDocumentField(foundry.documents.BaseItem, {
        required: true, fallback: true, label: "AAFO.Race"
      })
    };
  }
}
