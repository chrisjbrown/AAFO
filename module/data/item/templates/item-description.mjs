...
export default class ItemDescriptionTemplate extends SystemDataModel {
  ...
  static defineSchema() {
    return {
      description: new SchemaField({
        value: new HTMLField({required: true, nullable: true, label: "AAFO.Description"}),
        chat: new HTMLField({required: true, nullable: true, label: "AAFO.DescriptionChat"})
      }),
   ...
   */
  get validProperties() {
    return new Set(CONFIG.AAFO.validProperties[this.parent.type] ?? []);
  }
}
