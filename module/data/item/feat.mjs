...
export default class FeatData extends ItemDataModel.mixin(
  ...
  prepareDerivedData() {
    ...
    if ( this.type.value ) {
      const config = CONFIG.AAFO.featureTypes[this.type.value];
