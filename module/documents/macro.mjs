  ...
  switch ( dropData.type ) {
    case "Item":
      ...
      foundry.utils.mergeObject(macroData, {
        name: itemData.name,
        img: itemData.img,
        command: `aafo.documents.macro.rollItem("${itemData.name}")`,
        flags: {"aafo.itemMacro": true}
      });
      break;
    case "ActiveEffect":
      ...
      foundry.utils.mergeObject(macroData, {
        ...
        img: effectData.icon,
        command: `aafo.documents.macro.toggleEffect("${effectData.name}")`,
        flags: {"aafo.effectMacro": true}
      });
      break;
    default:
      return;
