...
export default class ScaleValueAdvancement extends Advancement {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      ...
      order: 60,
      icon: "systems/aafo/icons/svg/scale-value.svg",
      title: game.i18n.localize("AAFO.AdvancementScaleValueTitle"),
      hint: game.i18n.localize("AAFO.AdvancementScaleValueHint"),
      multiLevel: true,
      apps: {
